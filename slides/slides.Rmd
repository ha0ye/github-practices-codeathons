...
We have enough time to go over **basic** concepts and workflow practices.
...
* recording commits is done *manually*
  - what files have changes to record?  
...
For simple projects, your commits may follow a line:
  - each commit is a step forward

But you might want to work on different parts of your project at the same time!
